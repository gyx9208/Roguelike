...
namespace FullInspector.Internal {
    ...
    public class fiLateBindingsBinder {
        static fiLateBindingsBinder() {
			...
			fiLateBindings._Bindings._PrefabUtility_CreatePrefab = (string path, GameObject template) => PrefabUtility.SaveAsPrefabAsset(template,path);
            fiLateBindings._Bindings._PrefabUtility_IsPrefab = unityObj => PrefabUtility.GetPrefabInstanceStatus(unityObj) == PrefabInstanceStatus.Connected;
			fiLateBindings._Bindings._PrefabUtility_IsPrefabInstance = unityObj => PrefabUtility.GetPrefabInstanceStatus(unityObj) == PrefabInstanceStatus.Connected;
